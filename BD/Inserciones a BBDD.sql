...
INSERT INTO `maipo_grande`.`estados`(`ID_ESTADO`,`NOMBRE`,`DESCRIPCION`)VALUES(6,'RECHAZADO','PEDIDO FUE RECHAZADA POR COMPRADOR/POSTULACION RECHAZADA');
INSERT INTO `maipo_grande`.`estados`(`ID_ESTADO`,`NOMBRE`,`DESCRIPCION`)VALUES(7,'PAGADO','SE RECIBIO Y PAGO EL PEDIDO');
INSERT INTO `maipo_grande`.`estados`(`ID_ESTADO`,`NOMBRE`,`DESCRIPCION`)VALUES(8,'POSTULADO','SE POSTULO AL PEDIDO');
INSERT INTO `maipo_grande`.`estados`(`ID_ESTADO`,`NOMBRE`,`DESCRIPCION`)VALUES(9,'APROBADA','SE APROBO LA POSTULACION');
INSERT INTO `maipo_grande`.`estados`(`ID_ESTADO`,`NOMBRE`,`DESCRIPCION`)VALUES(10,'INFORMATIVA','TIPO DE ACTUALIZACION DE DESPACHO INFORMATIVA PARA EL CLIENTE');
INSERT INTO `maipo_grande`.`estados`(`ID_ESTADO`,`NOMBRE`,`DESCRIPCION`)VALUES(11,'ALERTA','TIPO DE ACTUALIZACION DE DESPACHO QUE ALERTA UN PROBLEMA CON EL PEDIDO');
