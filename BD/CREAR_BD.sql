...
CREATE TABLE PEDIDO (ID_PEDIDO INT PRIMARY KEY AUTO_INCREMENT, ID_VENDEDOR INT NOT NULL,ID_COMPRADOR INT NOT NULL,ID_TIPO_PEDIDO INT NOT NULL, ID_ESTADO_PEDIDO INT NOT NULL,
...
CREATE TABLE HISTORICO_TRANSACCIONES (ID_TRANSACCION INT, FECHA_TRANSACCION DATETIME, CORREO_COMPRADOR VARCHAR (100), CORREO_VENDEDOR VARCHAR (100), NOMBRE_FRUTA VARCHAR (100), 
