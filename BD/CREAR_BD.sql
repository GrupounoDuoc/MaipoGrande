...
REFRIGERADO BOOLEAN NOT NULL, TON_MAX FLOAT(12,3) NOT NULL,PRECIO_KM FLOAT(12,2), DESCRIPCION VARCHAR(150),PRIMARY KEY(ID_TRANSPORTISTA,METODO_VIAJE,REFRIGERADO));
...
CREATE TABLE POSTULACION (ID_POSTULACION INT PRIMARY KEY AUTO_INCREMENT, ID_DETALLE_PEDIDO INT NOT NULL, ID_TIPO_POSTULACION INT NOT NULL, ID_USUARIO INT NOT NULL, 
	ID_ESTADO INT NOT NULL, KG_APORTADOS FLOAT(6,3),PRECIO FLOAT(9,2));
