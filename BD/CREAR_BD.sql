...
CREATE TABLE DETALLE_TRANSPORTISTA (ID_DETALLE_TRANSPORTISTA INT PRIMARY KEY AUTO_INCREMENT,ID_TRANSPORTISTA INT, METODO_VIAJE VARCHAR(3) NOT NULL,
	REFRIGERADO BOOLEAN NOT NULL, TON_MAX FLOAT(6,3) NOT NULL,PRECIO_KM FLOAT(6,2) ,DESCRIPCION VARCHAR(150));
