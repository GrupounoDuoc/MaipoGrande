...
CREATE TABLE DETALLE_PEDIDO (ID_PEDIDO INT , ID_TIPO_FRUTA INT, ID_CALIDAD INT,METODO_VIAJE VARCHAR(3), REFRIGERADO tinyint(1), CANT_KG FLOAT(6,3), PRECIO_KG FLOAT(9,2), COD_MONEDA VARCHAR(3),
