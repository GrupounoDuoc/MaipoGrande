...
CREATE TABLE TIPO_FRUTA (ID_TIPO_FRUTA INT PRIMARY KEY AUTO_INCREMENT, NOMBRE VARCHAR(100) NOT NULL, DESCRIPCION VARCHAR(150));
CREATE TABLE CALIDAD (ID_CALIDAD INT PRIMARY KEY AUTO_INCREMENT, NOMBRE VARCHAR(100) NOT NULL,DESCRIPCION VARCHAR(150));
...
CREATE TABLE USUARIO (ID_USUARIO INT PRIMARY KEY AUTO_INCREMENT, CORREO VARCHAR(100) NOT NULL, CONTRASENA VARCHAR(250) NOT NULL, ID_PERFIL INT NOT NULL);
