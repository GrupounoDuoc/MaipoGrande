...
CREATE TABLE TIPO_PERSONA_LEGAL (ID_TIPO_PERSONA_LEGAL INT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL, DESCRIPCION VARCHAR(150));
CREATE TABLE ESTADOS (ID_ESTADO INT PRIMARY KEY, NOMBRE VARCHAR(20) NOT NULL, DESCRIPCION VARCHAR(150));
CREATE TABLE TIPO_TRANSPORTE (ID_TIPO_TRANSPORTE INT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL, VIA_TRANSPORTE VARCHAR(15) NOT NULL,
	REFRIGERADO BOOLEAN NOT NULL, TON_MAX FLOAT(6,3) NOT NULL, DESCRIPCION VARCHAR(150));
CREATE TABLE TIPO_FRUTA (ID_TIPO_FRUTA INT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL, DESCRIPCION VARCHAR(150));
CREATE TABLE CALIDAD (ID_CALIDAD INT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL,DESCRIPCION VARCHAR(150));
CREATE TABLE TIPO_POSTULACION (ID_TIPO_POSTULACION INT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL, DESCRIPCION VARCHAR(150) NOT NULL);
CREATE TABLE TIPO_PEDIDO (ID_TIPO_PEDIDO INT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL, DESCRIPCION VARCHAR(150));
CREATE TABLE PERFIL (ID_PERFIL INT PRIMARY KEY, NOMBRE VARCHAR(100) NOT NULL, DESCRIPCION VARCHAR(150));
CREATE TABLE USUARIO (ID_USUARIO INT PRIMARY KEY, CORREO VARCHAR(100) NOT NULL, CONTRASENA VARCHAR(250) NOT NULL, ID_PERFIL INT NOT NULL);
...
CREATE TABLE CONTRATO (ID_CONTRATO INT PRIMARY KEY, ID_USUARIO INT NOT NULL, CONTRATO BLOB, FECHA_FIRMA DATE NOT NULL, FECHA_VENCIMIENTO DATE NOT NULL);
CREATE TABLE PEDIDO (ID_PEDIDO INT PRIMARY KEY, ID_COMPRADOR INT NOT NULL, ID_TIPO_PEDIDO INT NOT NULL, ID_ESTADO_PEDIDO INT NOT NULL,
	FECHA_CREACION DATETIME NOT NULL, FECHA_LIMITE_O_RETIRO DATE, FECHA_PAGO DATETIME);
CREATE TABLE DETALLE_PEDIDO (ID_PEDIDO INT, ID_TIPO_FRUTA INT, ID_CALIDAD INT, CANT_KG FLOAT(6,3),
	PRIMARY KEY(ID_PEDIDO,ID_TIPO_FRUTA,ID_CALIDAD));
CREATE TABLE HISTORICO_STOCK (ID_STOCK INT PRIMARY KEY, ID_PROVEEDOR INT NOT NULL, ID_TIPO_FRUTA INT NOT NULL, ID_CALIDAD INT NOT NULL, 
	FECHA_REGISTRO DATETIME NOT NULL, CANT_KG FLOAT(6,3) NOT NULL, PRECIO_X_KG FLOAT(6,3) NOT NULL);
CREATE TABLE POSTULACION (ID_POSTULACION INT PRIMARY KEY, ID_PEDIDO INT NOT NULL, ID_TIPO_POSTULACION INT NOT NULL, ID_USUARIO INT NOT NULL, 
	ID_ESTADO INT NOT NULL, KG_APORTADOS FLOAT(6,3) NOT NULL);
CREATE TABLE DESPACHO (ID_DESPACHO INT PRIMARY KEY, ID_PEDIDO INT NOT NULL, ID_TRANSPORTISTA INT NOT NULL, ID_TIPO_TRANSPORTE INT NOT NULL,
