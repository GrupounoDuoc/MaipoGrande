...
BEGIN
    ...
    WHERE DP.ID_PEDIDO = $ID_PEDIDO) > 0 THEN
		#SE COMIENZA PROCESO DE ASIGNACION DE POSTULACIONES
		SELECT ID_POSTULACION,ID_DETALLE_PEDIDO,ID_TRANSPORTISTA INTO $ID_POSTULACION,$ID_DETALLE_PEDIDO,$ID_TRANSPORTISTA FROM POSTULACION P 
        JOIN DETALLE_PEDIDO DP ON DP.ID_DETALLE_PEDIDO = P.ID_DETALLE_PEDIDO
